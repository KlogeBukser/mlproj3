...
def main_gameplay():
    ...
    # TODO: Generates an AI instance, calls for input (fix time update?), change accordingly
    # needs changing
    ai = Ai()
...
def get_Random_Pipes():
    ...
    """
    pip_h = game_image['pipe'][0].get_height()
    off_s = scr_height / 3 *rng.choice([0.6,0.7,0.8,0.9,1.0])
